...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-agbvnnm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-agbvnnm.containers.anotherwebservice.com/
...
```
git clone git@github.com:Gskill-ctrl/container-agbvnnm.git
cd container-agbvnnm
```
...
```
docker attach container-agbvnnm
```
